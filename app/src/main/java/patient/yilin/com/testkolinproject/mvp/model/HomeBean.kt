package patient.yilin.com.testkolinproject.mvp.model

/**
 * Created by Administrator on 2017/9/1.
 */

data class HomeBean(var nextPageUrl:String?,var nextPublisgTime:Long,var newestIssueType:String?,var dialog:Any?,var issueList:List<IssueListBean>?){
    data class IssueListBean(var releaseTime:Long,var type:String?,var date:Long,var publishTime:Long,
